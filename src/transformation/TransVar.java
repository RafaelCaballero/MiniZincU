...
public class TransVar {
	...
	/**
	 * Constructs a TransVar object for variable v. This constructor also creates the transformation.
	 * @param v The variable that it is transformed. 
	 * @param p The base model
	 */
	...
	/**
	 * Adds the new variables and constraints generated by the transformation of a
	 * data variable related to the constructor i-th 
	 * @param i Number of constructor
	 * @param auxrec List of variable transformations associated to the i-th constructor.
	 *               It is assumed to have at least one element.
	 * @param id Identifier of the variable
	 * @param bigCtrl List of constraints. It is assumed to be different from null.
	 */
	 ...
	 * @return
	 */
	private List<List<TransVar>> recursiveCalls(VarDecl v, DataDef d,
			int size) {
