...
/**
 * Represents a substitution of MiniZinc variables by values. Used mainly for unfolding predicates and functions. 
 * @author rafa
 *
 *
 */
public class Substitution implements ExprTransformer  {
	...
	/**
	 * Creates a constructor that initializes the binding associated to the substitution.
	 * @param decls 
	 * @param largs
	 */
	...
	/* (non-Javadoc)
	 * @see transformation.ExprTransformer#transform(minizinc.representation.expressions.Expr)
	 */
	/**
