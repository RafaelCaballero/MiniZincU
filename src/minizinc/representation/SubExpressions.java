...
/**
 * The classes that implement this interface apply a transformer to all their first level. 
 * @author rafa
 *
 */
public interface SubExpressions{
	 ...
	 * @param t The transformer.
	 * @param e Any object implementing the interface {@link SubExpressions}
	 ...
	 * @param t The transformer.
	 * @param e Input list of expressions.
	 * @return null if no element of e has been transformed. 
	 * Otherwise, a list with the same length as  e. At the i-th position the list
	 * contains
	 * <ul>
	...
	/**
	 * Apply the transformations to all the subexpressions of elements in the list.
	 * @param t The transformer.
	 * @param e Input list of expressions.
	 * @return  A list with the same length as  e. At the i-th position the list
	 * contains the result of applying the transformation to all the subexpressions of the element.
